...
test:
	@machin test framework/machweb.src src/recfile.src src/engine.src src/registry.src src/cold.src src/coldbulk.src src/coldindex.src src/coldquery.src src/coldrange.src src/coldsort.src src/index.src src/range.src src/qcost.src src/project.src src/query.src src/order.src src/verify.src src/ready.src src/watch.src src/tenant.src src/servemeta.src src/servebulk.src src/serveread.src src/serveproxy.src src/servereset.src src/serverbac.src src/serve.src tests/engine_test.src | tail -1
	@machin test framework/machweb.src src/recfile.src src/engine.src src/registry.src src/cold.src src/coldbulk.src src/coldindex.src src/coldquery.src src/coldrange.src src/coldsort.src src/index.src src/range.src src/qcost.src src/project.src src/query.src src/order.src src/verify.src src/ready.src src/watch.src src/tenant.src src/servemeta.src src/servebulk.src src/serveread.src src/serveproxy.src src/servereset.src src/serverbac.src src/serve.src tests/unit_query_test.src | tail -1
	@machin test framework/machweb.src src/recfile.src src/engine.src src/registry.src src/cold.src src/coldbulk.src src/coldindex.src src/coldquery.src src/coldrange.src src/coldsort.src src/index.src src/range.src src/qcost.src src/project.src src/query.src src/order.src src/verify.src src/ready.src src/watch.src src/tenant.src src/servemeta.src src/servebulk.src src/serveread.src src/serveproxy.src src/servereset.src src/serverbac.src src/serve.src tests/unit_index_test.src | tail -1
	@machin test framework/machweb.src src/recfile.src src/engine.src src/registry.src src/cold.src src/coldbulk.src src/coldindex.src src/coldquery.src src/coldrange.src src/coldsort.src src/index.src src/range.src src/qcost.src src/project.src src/query.src src/order.src src/verify.src src/ready.src src/watch.src src/tenant.src src/servemeta.src src/servebulk.src src/serveread.src src/serveproxy.src src/servereset.src src/serverbac.src src/serve.src tests/unit_cold_test.src | tail -1
	@machin test framework/machweb.src src/recfile.src src/engine.src src/registry.src src/cold.src src/coldbulk.src src/coldindex.src src/coldquery.src src/coldrange.src src/coldsort.src src/index.src src/range.src src/qcost.src src/project.src src/query.src src/order.src src/verify.src src/ready.src src/watch.src src/tenant.src src/servemeta.src src/servebulk.src src/serveread.src src/serveproxy.src src/servereset.src src/serverbac.src src/serve.src tests/unit_tenant_test.src | tail -1
	@machin test framework/machweb.src src/recfile.src src/engine.src src/registry.src src/cold.src src/coldbulk.src src/coldindex.src src/coldquery.src src/coldrange.src src/coldsort.src src/index.src src/range.src src/qcost.src src/project.src src/query.src src/order.src src/verify.src src/ready.src src/watch.src src/tenant.src src/servemeta.src src/servebulk.src src/serveread.src src/serveproxy.src src/servereset.src src/serverbac.src src/serve.src tests/diff_cold_test.src | tail -1
...
qinject: build
	./scripts/query_injection_test.sh ./$(BIN)

idxcorrupt: build
	./scripts/index_corrupt_test.sh ./$(BIN)
...
verify: check test embed guide sdkversion journey backup projection routes durability isolation pagination inclause doccoverage telemetry indexbuild retention replicas concurrent diskfull ratelimit qinject idxcorrupt walpartial sigterm rbac promote soak bench crash fuzz

clean:
	rm -f $(BIN) $(BIN).mfl

.PHONY: build release stranger telemetry check test embed guide sdkversion journey backup projection routes durability isolation pagination inclause doccoverage telemetry indexbuild retention replicas concurrent diskfull ratelimit qinject idxcorrupt walpartial sigterm rbac promote soak bench crash verify clean
